...
export default function RegistrarPedidoPage() {
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(ellipse_at_top,_#12304f_0%,_#08111d_55%,_#030712_100%)] px-4 pt-20 pb-10">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-5 md:pt-4">
        <div className="w-full max-w-3xl">
          ...
          <section className="mt-5 rounded-[28px] border border-white/10 bg-white/[0.05] p-5 shadow-2xl shadow-black/20 backdrop-blur-xl md:p-6">
